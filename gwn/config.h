#ifndef __gwn_CONFIG_H__
#define __gwn_CONFIG_H__
    ...
    public:
        ...
        std::string toString() override{
            try{
                ...
                gwn_LOG_ERROR(gwn_LOG_ROOT()) << "ConfigVar::toString exception "
        ...
        bool fromString(const std::string& val) override{
            try{
                ...
                gwn_LOG_ERROR(gwn_LOG_ROOT()) << "ConfigVar::fromString exception "
        ...
        static typename ConfigVar<T>::ptr LookUp(const std::string& name
                ,const T& default_value,const std::string& description){
                    ...
                    if(it != GetDatas().end()) {
                        ...
                        if(temp){
                            gwn_LOG_INFO(gwn_LOG_ROOT()) << "Lookup name=" << name << " exists";
                            return temp;
                        }else{
                            gwn_LOG_ERROR(gwn_LOG_ROOT()) << "Lookup name=" << name << " exists but type not "
                    ...
                    if(name.find_first_not_of("abcdefghikjlmnopqrstuvwxyz._012345678")
                        != std::string::npos)
                    {
                        gwn_LOG_ERROR(gwn_LOG_ROOT()) << "Lookup name invalid " << name;
